...
DvppProcessClassify::DvppProcessClassify(aclrtStream &stream)
...
DvppProcessClassify::~DvppProcessClassify()
{
    DestroyResource();
...
void DvppProcessClassify::SetDvppType(DvppType dvppType)
{
    dvppType_ = dvppType;
}

Result DvppProcessClassify::InitResource()
{
...
void DvppProcessClassify::DestroyResource()
{
    if (dvppChannelDesc_ != nullptr)
    {
...
void DvppProcessClassify::SetInput4JpegD(char *inDevBuffer, uint32_t inDevBufferSize, const PicDesc &picDesc)
{
...
void DvppProcessClassify::GetDvppOutput(void **outputBuffer, int &outputSize)
{
...
Result DvppProcessClassify::InitDvppOutputPara(int modelInputWidth, int modelInputHeight)
{
...
void DvppProcessClassify::DestroyDvppOutputPara()
{
...
Result DvppProcessClassify::InitDecodeOutputDesc()
{
...
Result DvppProcessClassify::ProcessDecode()
{
...
void DvppProcessClassify::DestroyDecodeResource()
{
    if (decodeOutputDesc_ != nullptr)
    {
...
Result DvppProcessClassify::InitResizeInputDesc()
{
...
Result DvppProcessClassify::InitResizeOutputDesc()
{
...
Result DvppProcessClassify::Init8kResizeInputDesc()
{
...
Result DvppProcessClassify::Init8kResizeOutputDesc()
{
...
Result DvppProcessClassify::ProcessResize()
{
...
void DvppProcessClassify::DestroyResizeResource()
{
    if (resizeConfig_ != nullptr)
    {
...
Result DvppProcessClassify::InitCropInputDesc()
{
    uint32_t heightAlignment = 16;
    uint32_t sizeAlignment = 3;
    uint32_t sizeNum = 2;
...
Result DvppProcessClassify::InitCropOutputDesc()
{
    int sizeAlignment = 3;
    int sizeNum = 2;
...
Result DvppProcessClassify::ProcessCrop()
{
    resizeConfig_ = acldvppCreateResizeConfig();
    if (resizeConfig_ == nullptr)
    {
...
void DvppProcessClassify::DestroyCropResource()
{
    if (cropArea_ != nullptr)
    {
...
Result DvppProcessClassify::InitCropAndPasteInputDesc()
{
    uint32_t heightAlignment = 16;
    uint32_t sizeAlignment = 3;
    uint32_t sizeNum = 2;
...
Result DvppProcessClassify::InitCropAndPasteOutputDesc()
{
    int dvppOutWidth = modelInputWidth_;
    int dvppOutHeight = modelInputHeight_;
    int dvppOutWidthStride = modelInputWidth_;
...
Result DvppProcessClassify::ProcessCropAndPaste()
{
    resizeConfig_ = acldvppCreateResizeConfig();
    if (resizeConfig_ == nullptr)
    {
...
void DvppProcessClassify::DestroyCropAndPasteResource()
{
    if (cropArea_ != nullptr)
    {
        (void)acldvppDestroyRoiConfig(cropArea_);
...
void DvppProcessClassify::SetInput4JpegE(char *inDevBuffer, int inDevBufferSize, int inputWidth, int inputHeight)
{
    inDevBuffer_ = inDevBuffer;
...
uint32_t DvppProcessClassify::ComputeEncodeInputSize(int inputWidth, int inputHeight)
{
...
Result DvppProcessClassify::InitEncodeResource()
{
    uint32_t widthAlignment = 16;
    uint32_t heightAlignment = 2;
...
Result DvppProcessClassify::ProcessJpegE()
{
...
void DvppProcessClassify::DestroyEncodeResource()
{
...
Result DvppProcessClassify::Process8kResize()
{
...
Result DvppProcessClassify::Process()
{
    // pic decode
    INFO_LOG("call JpegD");
...
void DvppProcessClassify::DestroyDecodeOutBuff()
{
